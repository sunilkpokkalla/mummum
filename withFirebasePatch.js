    ...
    async (config) => {
      ...
      if (fs.existsSync(podfile)) {
        ...
        const postInstallPatches = [
          ...
          "        ",
          "        # Ensure dSYMs are generated for all targets (fixes Hermes dSYM issue)",
          ...
          "        ",
          "        if target.name.start_with?('RNFB') || target.name.include?('Firebase') || target.name.include?('hermes')",
